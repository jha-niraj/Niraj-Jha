	...
	projects: [
		{
			...
			links: [
				...
				{
					type: "Source",
					href: "https://github.com/jha-niraj/thecoderzofficial",
					icon: <Icons.github className="size-3" />,
				},
			],
			image: "/projects/thecoderz.png",
			video: "",
		},
		{
			title: "Shunya Tech",
			href: "https://shunya.nirajjha.xyz/",
			dates: " 2024 - Present",
			active: true,
			description:
				"Our own platform where we you can learn about our company and the projects that we have done for the clients and also the products that we have built for our own.",
			technologies: [
				"Next JS",
				"React.js",
				"Typescript",
			...
			links: [
				...
				{
					type: "Source",
					href: "https://github.com/jha-niraj/ShunyaTech",
					icon: <Icons.github className="size-3" />,
				},
			],
			image: "/projects/shunyatech.png",
			video: "",
		},
		{
			title: "TrueFolio",
			href: "https://truefolio.vercel.app/",
			dates: "June 2025 - Present",
			active: true,
			description:
				"An platform which trace out the true information about you across all the platform and also gives you insights about the future and next steps.",
			technologies: [
				"Next.js",
				"Typescript",
				"PostgreSQL",
			...
			links: [
				...
				{
					type: "Source",
					href: "https://github.com/jha-niraj/True-Folio",
					icon: <Icons.github className="size-3" />,
				},
			],
			image: "/projects/truefolio.png",
			video: "",
		},
		{
			title: "Gururkul",
			...
			active: true,
			description:
				"About This is an school management saas platform where we are providing all the features at one place from billing to examination and question paper generation and answer checking to the communication.",
			technologies: [
				"Next.js",
				"Typescript",
				"PostgreSQL",
			...
			image: "/projects/gurukul.png",
			video: "",
		},
		{
			title: "VyaparSetu",
			href: "https://setu.nirajjha.xyz/",
			dates: "June 2025 - Present",
			active: true,
			description:
				"An platform where we are building each and everything to replace the old 'Bahi Khata' means book ledger into digital platform for the ease of the business.",
			technologies: [
				"Next.js",
				"Typescript",
				"PostgreSQL",
			...
			links: [
				...
				{
					type: "Source",
					href: "https://github.com/jha-niraj/VyaparSetu",
					icon: <Icons.github className="size-3" />,
				},
			],
			image: "/projects/setu.png",
			video: "",
		},
		{
			title: "ValidateX",
			...
			active: true,
			description:
				"Validate Your Ideas with Our Community. Submit your ideas, get feedback from a global community, and reward validators using blockchain technology.",
			technologies: [
				"Next.js",
				"Typescript",
				"PostgreSQL",
		...
		{
			title: "Speak Fluent",
			href: "https://speak.nirajjha.xyz",
			dates: "June 2025 - Present",
			active: true,
			description:
				"An one stop platform for all the needs related to practice language to being master in language like native.",
			technologies: [
				"Next.js",
				"Typescript",
				"PostgreSQL",
			...
			links: [
				...
				{
					type: "Source",
					href: "https://github.com/jha-niraj/SpeakFluent",
					icon: <Icons.github className="size-3" />,
				},
			],
			image: "/projects/speakfluent.png",
			video: "",
		},
		{
			title: "M.P. Solutions",
			href: "https://mpsolutions.com.np",
			dates: "June 2025 - Present",
			active: true,
			description:
				"This is the platform for the medicine and equipment delivery company where the user can see the products and order or get an quote for the products and more informations.",
			technologies: [
				"Next.js",
				"Typescript",
				"PostgreSQL",
			...
			links: [
				...
				{
					type: "Source",
					href: "https://github.com/jha-niraj",
					icon: <Icons.github className="size-3" />,
				},
			],
			image: "/projects/mpsolutions.png",
			video: "",
		},
		{
			title: "Paytm Clone",
